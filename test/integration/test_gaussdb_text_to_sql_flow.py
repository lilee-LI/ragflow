...
def _install_dialog_service_import_stubs(monkeypatch):
    ...
    install_module(
        ...
        resolve_model_config=lambda *_args, **_kwargs: {},
    ...
    advanced_rag = install_module("rag.advanced_rag", DeepResearcher=Dummy)
    advanced_rag.__path__ = []
    install_module("rag.advanced_rag.agentic_rag", RAGTools=Dummy)
    knowledge_compile = install_module("rag.advanced_rag.knowlege_compile")
    knowledge_compile.__path__ = []
    install_module("rag.advanced_rag.knowlege_compile.mind_map_extractor", MindMapExtractor=Dummy)
