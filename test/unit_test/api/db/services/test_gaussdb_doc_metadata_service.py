...
def test_update_document_metadata_uses_delete_insert_for_gaussdb(monkeypatch, doc_metadata_context):
    service = doc_metadata_context.DocMetadataService
    module = doc_metadata_context.module
    settings = doc_metadata_context.settings
    ...
    assert fake.deleted == [({"id": "doc1"}, "ragflow_doc_meta_tenant1", "kb1")]
